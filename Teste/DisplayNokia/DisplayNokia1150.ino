...
static const uint8_t sino[1024] = {
...
static const uint8_t calendario[1024] = {
...
static const uint8_t livro[1024] = {
...
void loop() 
  ...
  display.drawBitmap(30, 0, sino, 20, 20, 1);
  ...
  display.drawBitmap(0, 0, livro, 20, 20, 1);
  display.setTextColor(BLACK);
  display.setCursor(0,25);
  display.setTextSize(0.5);
  ...
  display.drawBitmap(0, 0, calendario, 20, 20, 1);
  display.setTextColor(BLACK);
  display.setCursor(0,25);
