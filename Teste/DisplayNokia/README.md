...
##### •*[1, 2]* Os dois primeiros parâmetros (0,0) se referem, respectivamente, ao X e Y iniciais da imagem. Ou seja, onde a imagem se iniciará.
##### •*[3]* Após isso, o terceiro parâmetro. Ele se refere ao vetor que possui nossa imagem em bitmap. 
